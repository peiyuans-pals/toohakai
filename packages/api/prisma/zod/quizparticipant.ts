...
export interface CompleteQuizParticipant extends z.infer<typeof QuizParticipantModel> {
  Quiz: CompleteQuiz
  User: CompleteUser
}
 ...
 */
export const RelatedQuizParticipantModel: z.ZodSchema<CompleteQuizParticipant> = z.lazy(() => QuizParticipantModel.extend({
